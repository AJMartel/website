  ...
  constructor($rootScope, $scope, $timeout) {
    ...
    $scope.downloads = [
      ...
      },
      {
        name: "Mac",
        icon: "ico-apple.png",
        link: "https://github.com/standardnotes/desktop/releases/download/v0.2.8/standard-notes-0.2.8-mac.zip",
        screenshots: [
      ...
      },
      {
        ...
        link: "https://github.com/standardnotes/desktop/releases/download/v0.2.8/standard-notes-Setup-0.2.8.exe",
        screenshots: [
      ...
      },
      {
        name: "Linux",
        icon: "ico-linux.png",
        link: "https://github.com/standardnotes/desktop/releases/download/v0.2.8/standard-notes-0.2.8-x86_64.AppImage",
        screenshots: [
          "https://s3.amazonaws.com/standard-notes/screenshots/desktop/jpg/1.jpg",
          "https://s3.amazonaws.com/standard-notes/screenshots/desktop/jpg/2.jpg",
          "https://s3.amazonaws.com/standard-notes/screenshots/desktop/jpg/3.jpg",
